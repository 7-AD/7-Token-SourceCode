...
contract SevenToken is IERC20 {
    string public constant name = "7 Token";
    string public constant symbol = "AD";
    uint8 public constant decimals = 18;
    uint256 private _totalSupply = 10000000 * 10**uint256(decimals); // 10 million tokens with 18 decimals
